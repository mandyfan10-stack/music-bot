-- Repository baseline imported with the Supabase history.
-- Before linking production, replace/confirm this snapshot against supabase db pull
-- and mark it applied only after a zero schema diff. Do not execute it on production.
